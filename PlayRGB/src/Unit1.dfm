object Form1: TForm1
  ...
  Caption = 'PlayRGB -> PlayOn!HD conversion tool'
  ClientHeight = 110
  ClientWidth = 346
  Color = clBtnFace
  ...
  object KOLProject1: TKOLProject
    ...
    projectName = 'playrgb'
    projectDest = 'playrgb'
    sourcePath = 'D:\Fujifilm\gotowe\rgb565\'
    outdcuPath = 'D:\Fujifilm\gotowe\rgb565\'
    dprResource = False
    protectFiles = True
    showReport = False
    isKOLProject = True
  ...
  object KOLForm1: TKOLForm
    ...
    Tabulate = False
    TabulateEx = False
    UnitSourcePath = 'D:\Fujifilm\gotowe\rgb565\'
    Locked = False
    formUnit = 'Unit1'
    formMain = True
    Enabled = True
  ...
  object OpenDialog: TKOLOpenSaveDialog
    ...
    NoPlaceBar = False
    Title = 'Select file for RGB565 conversion'
    Filter = 'Bitmap|*.bmp'
    FilterIndex = 0
    DefExtension = 'bmp'
    OpenDialog = True
